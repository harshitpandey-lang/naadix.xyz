...
async function load() {
  ...
  try {
    ...
    if (params.get("filter") === "AT_RISK") { state.filter = "AT_RISK"; renderWorkspace(); }
    if (params.get("new") === "1") { const projectId = params.get("project"); history.replaceState(null, "", "/hq/goals/"); openGoalForm(null, null, projectId); return; }
