...
const icons = {
  ...
  development: '<svg viewBox="0 0 20 20" aria-hidden="true"><path d="M10 3v14M4 8h12M6 4h8l2 4-6 9-6-9z"/></svg>',
  learning: '<svg viewBox="0 0 20 20" aria-hidden="true"><path d="M3 5.5 10 3l7 2.5-7 2.5zM5 8v4.5c0 1.4 2.2 2.5 5 2.5s5-1.1 5-2.5V8"/></svg>',
  notes: '<svg viewBox="0 0 20 20" aria-hidden="true"><path d="M5 3h8l2 2v12H5zM12 3v4h4M7.5 10h5M7.5 13h4"/></svg>',
...
function navigation(active) {
  return [
    ...
    ["decisions", "Decisions", "/hq/decisions/"],
    ["development", "Development", "/hq/development/"],
    ["learning", "Learning", "/hq/learning/"],
    ["notes", "Notes", "/hq/notes/"],
    ["review", "Review", "/hq/review/"],
...
function openCommandPalette() {
  const commands = [
    ...
    ["Development", "Open skills and growth areas", "/hq/development/", "development"],
    ["Learning", "Open the learning queue", "/hq/learning/", "learning"],
    ["Notes", "Open private notes", "/hq/notes/", "notes"],
    ...
    ["New Development Area", "Create a growth area", "/hq/development/?new=area", "development"],
    ["New Learning Item", "Add a course, book, paper, or topic", "/hq/learning/?new=1", "learning"],
    ["New Note", "Capture durable context", "/hq/notes/?new=1", "notes"],
