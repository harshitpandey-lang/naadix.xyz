...
export function layout(path, title, description, body) {
 ...
 <nav id="mobile-menu" aria-label="Mobile" hidden>${link("Home", "/")}${navigation.map(([t, h]) => link(t, h)).join("")}${link("Founder HQ", `${c.hq}/`)}${link("Contact", "/contact/")}</nav>
